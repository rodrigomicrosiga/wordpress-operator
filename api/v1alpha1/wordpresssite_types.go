...
type WordpressSiteStatus struct {
	...
	// conditions represent the current state of the WordpressSite resource.
...
type WordpressSite struct {
	...
	// spec defines the desired state of WordpressSite
	// +required
	Spec WordpressSiteSpec `json:"spec"`

	// status defines the observed state of WordpressSite
	// +optional
	Status WordpressSiteStatus `json:"status,omitzero"`
}
